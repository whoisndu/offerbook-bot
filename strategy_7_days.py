...
Strategy:
  ...
  4. Post a new lending offer at benchmark_apy * 0.90 (10% below benchmark) to be competitive.
  5. Enforce:
...
# Strategy parameters
APY_DISCOUNT = 0.10          # undercut the market benchmark (volume-weighted median) by 10%
MAX_DURATION_DAYS = 7
